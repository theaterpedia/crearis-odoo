...
from odoo.addons.graphql_theaterpedia.schemas.objects import PaymentProvider, PaymentTransaction
from odoo.addons.graphql_theaterpedia.schemas.shop import Cart, CartData
